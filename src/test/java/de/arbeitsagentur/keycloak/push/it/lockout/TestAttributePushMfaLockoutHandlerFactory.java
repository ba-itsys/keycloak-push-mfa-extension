...
public class TestAttributePushMfaLockoutHandlerFactory implements PushMfaLockoutHandlerFactory {

    public static final String ID = "test-attribute";

    private static final TestAttributePushMfaLockoutHandler SINGLETON = new TestAttributePushMfaLockoutHandler();
